...
{
       0,    27,    27,    30,    40,    43,    45,    48,    59,    70,
      83,   100,   102,   106,   116,   119,   129,   139,   149,   151,
     153,   156,   166,   169,   179,   182,   184,   186,   188,   190,
     193,   195,   198,   203,   210,   216,   219,   224,   229,   232,
     236,   243,   248,   252,   258,   264,   270,   276,   282,   289,
     294,   297,   303,   310,   315,   318,   324,   331,   333,   335,
     337,   340,   345,   350,   360,   363,   368
};
#endif
...
static const char *const yytname[] =
{
  ...
  "RETURN", "NUM", "ID", "ASSIGN", "EQ", "NEQ", "LT", "LTE", "GT", "GTE",
  "PLUS", "MINUS", "TIMES", "OVER", "LPAREN", "RPAREN", "LBRACKET",
  "RBRACKET", "LKEY", "RKEY", "COMMA", "SEMI", "ERROR", "ENDFILE",
  "$accept", "programa", "declaracao_lista", "declaracao",
  "var_declaracao", "fun_declaracao", "params", "param_lista", "param",
...
#line 60 "cminus.y" /* yacc.c:1646  */
    {     (yyval) = newExpNode(TypeK);
                                    ...
                                    (yyvsp[-4])->attr.val = (yyvsp[-2])->attr.val;
...
#line 1849 "cminus.tab.c" /* yacc.c:1646  */
    break;
